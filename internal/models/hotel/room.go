...
type Room struct {
	...
	Image       string         `json:"image" binding:"omitempty,url"` // simpan URL absolut
...
type CreateRoomRequest struct {
	...
	Image       string `json:"image" form:"-"` // diisi otomatis dengan URL absolut
}
...
type UpdateRoomRequest struct {
	...
	Image       *string `json:"image" binding:"omitempty,url"` // URL absolut
