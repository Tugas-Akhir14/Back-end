...
type NewsService interface {
	Create(input hotel.News, img *multipart.FileHeader, creatorID uint) (*hotel.News, error)
	Update(id uint, input hotel.News, img *multipart.FileHeader, updaterID uint) (*hotel.News, error)
	Delete(id uint) error
	GetByID(id uint) (*hotel.News, error)
	GetBySlug(slug string) (*hotel.News, error)
	List(page, pageSize int, q, status string) ([]hotel.News, int64, error)
}
...
func (s *newsService) Update(id uint, input hotel.News, img *multipart.FileHeader, updaterID uint) (*hotel.News, error) {
