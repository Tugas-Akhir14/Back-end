...
type AdminService interface {
    Register(admin *auth.Admin, confirmPassword string) error
    Login(email, password string) (string, error)
    GetProfile(id uint) (*auth.Admin, error)
}
...
func (s *adminService) Register(admin *auth.Admin, confirmPassword string) error {
...
func (s *adminService) GetProfile(id uint) (*auth.Admin, error) {
