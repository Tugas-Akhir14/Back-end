...
type GalleryHandler struct{ service service.GalleryService }

func NewGalleryHandler(s service.GalleryService) *GalleryHandler { return &GalleryHandler{s} }
...
func (h *GalleryHandler) UpdateImage(c *gin.Context) {
	...
	if _, err := h.service.Update(uint(id), models.UpdateGalleryRequest{}); err != nil {
