...
type VisionMissionHandler struct {
	svc service.VisionMissionService
}

func NewVisionMissionHandler(s service.VisionMissionService) *VisionMissionHandler {
...
func (h *VisionMissionHandler) Upsert(c *gin.Context) {
	var req models.UpsertVisionMissionRequest
